        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12">
          ...
          <div className="transform transition-all duration-300 hover:translate-y-[-5px]">
            ...
            <div className="space-y-3 sm:space-y-6">
              <a href={SUPPORT_TEL_URL} className="block group">
                <div className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-white/5 rounded-lg transition-all duration-300 hover:bg-white/10">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-sm sm:text-base">{SUPPORT_PHONE_DISPLAY}</div>
                  </div>
                </div>
              </a>

              <a href={SUPPORT_WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="block group">
                <div className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-white/5 rounded-lg transition-all duration-300 hover:bg-white/10">
                  <div className="p-2 sm:p-3 bg-green-500/20 rounded-full group-hover:bg-green-500/30 transition-all duration-300">
                  ...
                  <div>
                    <div className="text-xs sm:text-sm text-cosmic-silver">WhatsApp</div>
                    <div className="font-medium text-sm sm:text-base">Text us on WhatsApp</div>
                  </div>
                </div>
              </a>
